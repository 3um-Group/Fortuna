...
export function ConnectWithSelect({
  ...
  const validChainIds: number[] = chainIds.filter((id): id is number => id !== undefined);

  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      {!(connector instanceof GnosisSafe) && (
        <ChainSelect activeChainId={desiredChainId} switchChain={switchChain} chainIds={validChainIds} />
      )}
      ...
      {isActive ? (
        ...
        <button
          ...
          disabled={isActivating || desiredChainId === undefined}
        >
